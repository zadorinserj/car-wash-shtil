...
export const metadata = {
	title:
		'Мойка кузова и радиатора автомобиля в Ижевске – быстро, чисто, выгодно!',
	description:
		'Мойка кузова и чистка радиатора в Ижевске по доступным ценам. Гарантия качества! '
}
	...
	return (
		<div>
			<MainBlock
				...
				title={
					<>
						Мойка кузова <br /> и радиатора <br /> автомобиля
					</>
				}
			/>
