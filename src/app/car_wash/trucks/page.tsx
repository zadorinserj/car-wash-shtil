...
export const metadata = {
	title: 'Автомойка грузовых машин рядом с вами',
	description:
		'Ищете автомойку для грузовика? Мы предлагаем услуги мойки грузовых автомобилей по доступным ценам.'
}
